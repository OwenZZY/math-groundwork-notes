...
\newcommand{\LPSA}{Linear Program (\ref{lps}) in Assumption~\ref{assumption: lps}}
% ----------------------------------------------------------------------
% common symbols
...
\newenvironment{assumption}{\begin{mdframed}[linewidth=1pt,            
        innerleftmargin=10pt,
        innertopmargin=8pt,
        skipabove=10pt] 
\vspace{-\topsep}\begin{n-assumption}}{\end{n-assumption}\end{mdframed}}
